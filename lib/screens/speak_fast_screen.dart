...
class _SpeakFastScreenState extends State<SpeakFastScreen> {
  ...
  static const Map<String, Map<String, List<String>>> _content = {
    ...
    'Medium': {
      ...
      'Travel': [
        "Traveling broadens your mind and challenges your comfort zone.",
        "Always research local customs before visiting a new country.",
        ...
        "Travel insurance is something you hope you never need but always should have.",
        "The best souvenirs are the memories you bring back home.",
        "Jet lag is your body's way of saying it misses your bed.",
        "Street food often gives you the most authentic local flavors.",
        "A good travel companion can make any trip ten times better.",
        "Pack light and you'll thank yourself at every transfer.",
        "Solo travel teaches you independence and self-reliance.",
        "Some of the best destinations are off the beaten path.",
        "Always keep a copy of your important documents somewhere safe.",
        "Public transportation is the best way to experience a city like a local.",
        "The journey itself is often more memorable than the destination.",
        "Night trains save you time and money on accommodation.",
        "Respect the environment wherever you travel.",
        "Connecting with locals creates the richest travel experiences.",
        "A flexible itinerary leaves room for unexpected adventures.",
        "Coming home after a great trip makes you appreciate both worlds.",
      ],
      'Health': [
        "A balanced diet is the foundation of good health.",
        "Regular exercise reduces the risk of chronic diseases significantly.",
        "Mental health is just as important as physical health.",
        "Sleep deprivation affects your mood, memory, and immune system.",
        "Staying hydrated improves concentration and energy levels.",
        "Stress management techniques include meditation and deep breathing.",
        "Preventive healthcare catches problems before they become serious.",
        "Your posture affects your spine, digestion, and even your confidence.",
        "Processed foods often contain hidden sugars and unhealthy fats.",
        "Walking thirty minutes a day can transform your cardiovascular health.",
        "Vaccines are one of humanity's greatest medical achievements.",
        "Screen time before bed disrupts your natural sleep cycle.",
        "Social connections contribute significantly to emotional well-being.",
        "Stretching daily improves flexibility and prevents injuries.",
        "Your gut health influences your immune system and mental state.",
        "Moderation is the key to a sustainable healthy lifestyle.",
        "Regular check-ups help detect health issues early.",
        "Laughter genuinely boosts your immune system and reduces stress.",
        "Healthy habits compound over time to produce remarkable results.",
        "Taking care of your body is an investment, not an expense.",
      ],
      'Science': [
        ...
        "Photosynthesis converts sunlight into energy that sustains most life.",
        "Black holes are regions where gravity is so strong that nothing escapes.",
        "Antibiotics revolutionized medicine but overuse creates resistant bacteria.",
        ...
        "The water cycle continuously recirculates Earth's water supply.",
        ...
        "Nuclear fusion powers the sun and could one day power our cities.",
        "Scientific literacy helps citizens make informed decisions about policy.",
      ],
      'Sports': [
        "Professional athletes dedicate thousands of hours to perfecting their craft.",
        "Teamwork and communication separate good teams from great ones.",
        "The Olympic Games bring together athletes from over two hundred nations.",
        "Sports psychology helps athletes manage pressure and maintain focus.",
        "Proper nutrition is essential for athletic performance and recovery.",
        "Cross-training helps prevent injury by strengthening different muscle groups.",
        "The World Cup is the most watched sporting event on the planet.",
        "Sportsmanship means respecting your opponents regardless of the outcome.",
        "Data analytics is transforming how coaches develop game strategies.",
        "Recovery days are just as important as training days.",
        "Marathon running tests both physical endurance and mental strength.",
        "Youth sports teach valuable life skills like discipline and teamwork.",
        "Injuries are inevitable, but proper rehabilitation makes comebacks possible.",
        "The home crowd advantage is a real psychological phenomenon.",
        "E-sports have grown into a billion-dollar global industry.",
        "Fair play rules exist to protect athletes and preserve competition integrity.",
        "Warming up properly reduces the risk of muscle strains and tears.",
        "Great coaches inspire confidence and bring out the best in people.",
        "Consistency in training produces better results than occasional intense efforts.",
        "Sports unite people across cultures, languages, and backgrounds.",
      ],
      'Entertainment': [
        "Streaming services have completely changed how we consume media.",
        "A well-told story can change the way you see the world.",
        "Music has the unique ability to evoke powerful emotions instantly.",
        "Podcasts have democratized knowledge sharing and storytelling.",
        "The film industry generates hundreds of billions in revenue annually.",
        "Live performances create a connection between artist and audience.",
        "Video games are now recognized as a legitimate art form.",
        "Reading fiction develops empathy by putting you in someone else's shoes.",
        "Social media has blurred the line between consumers and creators.",
        "Animation technology has advanced from hand-drawn to photorealistic rendering.",
        "Stand-up comedy requires incredible timing and audience awareness.",
        "Documentaries educate while entertaining and sparking important conversations.",
        "The rise of independent creators has diversified entertainment options.",
        "Virtual reality is creating entirely new forms of immersive storytelling.",
        "Cultural entertainment reflects society's values, fears, and aspirations.",
        "Binge-watching is enjoyable but moderation keeps it sustainable.",
        "Board games and puzzles offer screen-free entertainment and social bonding.",
        "Creative hobbies like painting and writing provide therapeutic benefits.",
        "Concert experiences create memories that last a lifetime.",
        "Entertainment is not just escape; it's a way to understand humanity.",
      ],
    },
    'Hard': {
      'Casual': [
      ...
      'Travel': [
        "The contemporary phenomenon of overtourism has precipitated an existential crisis for heritage sites struggling to reconcile preservation imperatives with economic dependency on visitor revenue.",
        "Sustainable tourism frameworks necessitate a fundamental reconceptualization of the relationship between traveler consumption patterns and host community ecological carrying capacity.",
        "The geopolitics of visa reciprocity arrangements illuminate profound asymmetries in global mobility privileges that correlate disturbingly with historical colonial power dynamics.",
        "Cultural commodification through tourism transforms authentic traditions into performative spectacles, raising uncomfortable questions about whose narrative of place ultimately prevails.",
        "The aviation industry's carbon footprint represents approximately three percent of global emissions, compelling urgent exploration of sustainable aviation fuels and alternative propulsion technologies.",
        "Digital nomadism as a lifestyle phenomenon has catalyzed complex discussions about taxation jurisdiction, labor law applicability, and the socioeconomic impact on destination communities.",
        "The psychological concept of 'transformative travel' posits that genuinely meaningful journeys fundamentally alter one's epistemic frameworks and self-understanding in ways conventional tourism cannot.",
        "Ecotourism certification schemes vary enormously in rigor and accountability, creating a landscape where greenwashing masquerades as genuine environmental stewardship with alarming frequency.",
        "The resurrection of transcontinental rail travel represents both a nostalgic romanticism and a pragmatic response to the environmental unsustainability of short-haul aviation.",
        "Anthropological perspectives on pilgrimage reveal that the human impulse toward sacred journey predates organized religion and persists in secular forms throughout contemporary culture.",
        "The intersection of artificial intelligence and travel planning raises questions about algorithmic homogenization of experience and the erosion of serendipitous discovery.",
        "Culinary tourism has evolved from peripheral activity to primary travel motivation, driving economic revitalization of regions previously overlooked by conventional itineraries.",
        "The psychological phenomenon of 'post-travel depression' reflects the cognitive dissonance between the heightened awareness cultivated through travel and the routine consciousness of everyday life.",
        "Accessible tourism infrastructure remains woefully inadequate globally, effectively excluding millions of individuals with disabilities from participation in transformative travel experiences.",
        "The ethical dimensions of voluntourism demand critical examination of whether short-term charitable interventions by untrained travelers genuinely benefit or inadvertently harm recipient communities.",
      ],
      'Health': [
        "The bidirectional relationship between the gut microbiome and neurological function — the so-called gut-brain axis — represents one of medicine's most revolutionary contemporary frontiers.",
        "Epigenetic mechanisms demonstrate that environmental factors can modify gene expression across generations without altering the underlying DNA sequence, fundamentally challenging genetic determinism.",
        "The social determinants of health — encompassing socioeconomic status, education, neighborhood environment, and social cohesion — account for approximately eighty percent of health outcomes.",
        "Precision medicine leverages genomic, proteomic, and metabolomic data to tailor therapeutic interventions to individual biological profiles rather than applying population-level treatment protocols.",
        "The pharmaceutical industry's orphan drug development paradox illustrates the tension between market-driven research incentives and the ethical imperative to address rare disease populations.",
        "Chronobiology research reveals that disruption of circadian rhythms through shift work and artificial light exposure contributes to metabolic syndrome, cardiovascular disease, and cognitive decline.",
        "The placebo effect, far from being merely psychosomatic, activates measurable neurochemical cascades involving endorphins, dopamine, and endocannabinoids that produce genuine physiological changes.",
        "Antimicrobial resistance represents a catastrophic threat to modern medicine, potentially rendering routine surgical procedures and cancer chemotherapy lethally dangerous within decades.",
        "The integration of artificial intelligence in diagnostic imaging has achieved sensitivity and specificity levels that rival or exceed experienced radiologists across multiple pathological domains.",
        "Longevity research increasingly focuses on cellular senescence and the possibility that targeted senolytic therapies could extend healthspan by eliminating dysfunctional aged cells.",
        "The commodification of wellness culture has created a parallel healthcare marketplace where unregulated supplements and unvalidated protocols exploit vulnerable individuals seeking health optimization.",
        "Neuroplasticity research has overturned the longstanding dogma that adult brain architecture is fixed, demonstrating remarkable capacity for structural and functional reorganization throughout the lifespan.",
        "The global mental health crisis has exposed catastrophic underfunding and systemic stigmatization that prevent the majority of affected individuals from accessing evidence-based interventions.",
        "Telemedicine adoption has permanently altered healthcare delivery paradigms, simultaneously improving access for underserved populations while raising concerns about diagnostic accuracy and therapeutic alliance.",
        "The immunotherapy revolution in oncology harnesses the patient's own immune system to target malignancies with unprecedented specificity, achieving durable remissions in previously intractable cancers.",
      ],
      'Science': [
        "The standard model of particle physics, while extraordinarily predictive, remains fundamentally incomplete in its inability to incorporate gravitational interactions or explain dark matter composition.",
        "CRISPR-Cas9 gene editing technology has democratized genomic manipulation with unprecedented precision, simultaneously promising therapeutic breakthroughs and raising profound ethical questions about germline modification.",
        "The measurement problem in quantum mechanics — the apparent collapse of superposition upon observation — remains perhaps the most philosophically contentious issue in all of physical science.",
        "Abiogenesis research investigates the transition from prebiotic chemistry to self-replicating molecular systems, seeking to explain how inanimate matter spontaneously organized into living entities.",
        "The accelerating expansion of the universe, attributed to dark energy comprising approximately sixty-eight percent of total cosmic energy density, challenges our fundamental understanding of vacuum physics.",
        "Synthetic biology aims to engineer biological systems with novel functionalities by applying engineering principles of modularity, standardization, and abstraction to genetic circuit design.",
        "The Fermi Paradox — the apparent contradiction between the high probability of extraterrestrial civilizations and the absence of observable evidence — remains an unresolved scientific puzzle.",
        "Consciousness studies at the intersection of neuroscience and philosophy struggle to explain how subjective phenomenal experience arises from objective neurobiological processes — the so-called 'hard problem.'",
        "The thermohaline circulation system that drives global ocean currents is demonstrably weakening due to polar ice melt and freshwater influx, with potentially catastrophic climatic consequences.",
        "Metamaterials engineering enables the fabrication of structures with electromagnetic properties not found in nature, including negative refractive indices that theoretically permit acoustic and optical cloaking.",
        "The anthropic principle in cosmology observes that the fundamental physical constants appear extraordinarily fine-tuned for the emergence of complexity, consciousness, and carbon-based life.",
        "Epigenomic landscapes reveal that identical genetic sequences can produce radically different phenotypic outcomes depending on the constellation of methylation patterns and histone modifications present.",
        "The holographic principle in theoretical physics suggests that the information content of a volume of space can be described by a theory operating on its boundary surface.",
        "Biomimicry applies evolutionary solutions refined over billions of years to contemporary engineering challenges, from self-cleaning surfaces inspired by lotus leaves to structural materials mimicking spider silk.",
        "The reproducibility crisis in empirical science has exposed systemic incentive structures that inadvertently promote publication bias, questionable research practices, and insufficient methodological transparency.",
      ],
      'Sports': [
        "The biomechanical analysis of athletic performance has evolved from observational coaching methodology to sophisticated computational modeling utilizing motion capture and force plate instrumentation.",
        "Periodization theory in exercise science prescribes systematic variation of training volume and intensity across macrocycles to optimize physiological adaptation while minimizing overtraining syndrome risk.",
        "The commercial monetization of professional athletics through broadcasting rights, sponsorship agreements, and merchandise licensing has transformed sports into a multi-trillion-dollar global entertainment industry.",
        "Altitude training exploits the physiological adaptation to hypoxic environments, stimulating erythropoietin production and increasing oxygen-carrying capacity through elevated red blood cell concentrations.",
        "The ethical complexities surrounding transgender athlete participation in competitive sports involve irreconcilable tensions between inclusion principles and legitimate concerns about physiological competitive advantages.",
        "Sports governance structures face persistent credibility challenges from corruption scandals, doping cover-ups, and the geopolitical instrumentalization of mega-events by authoritarian regimes.",
        "The neurological basis of athletic expertise involves pattern recognition, anticipatory motor programming, and decision-making processes that operate below conscious awareness at speeds precluding deliberative reasoning.",
        "Concussion research in contact sports has revealed the devastating long-term neurological consequences of repetitive subconcussive impacts, including chronic traumatic encephalopathy and early-onset neurodegenerative disease.",
        "The statistical revolution in sports analytics has transformed talent identification, tactical optimization, and player valuation through the systematic application of Bayesian inference and machine learning algorithms.",
        "Youth athlete development pathways increasingly emphasize multilateral physical literacy over early specialization, reflecting evidence that diverse movement experiences produce superior long-term competitive outcomes.",
        "The intersection of wearable technology and sports science enables real-time monitoring of physiological load markers including heart rate variability, GPS-derived locomotor metrics, and neuromuscular fatigue indicators.",
        "Anti-doping enforcement faces an perpetual asymmetry wherein detection methodologies invariably lag behind the development of novel performance-enhancing substances and sophisticated micro-dosing protocols.",
        "The psychological resilience required for athletic excellence encompasses growth mindset orientation, adaptive perfectionism, cognitive reappraisal skills, and robust self-determined motivational profiles.",
        "Esports professionalization has introduced ergonomic concerns including repetitive strain injuries, postural dysfunction, and the metabolic consequences of prolonged sedentary screen engagement characteristic of competitive gaming.",
        "The philosophical debate regarding the nature of competition interrogates whether sport constitutes a zero-sum contest for dominance or a collaborative endeavor pursuing mutual excellence through structured opposition.",
      ],
      'Entertainment': [
        "The algorithmic curation of cultural content by streaming platforms simultaneously democratizes access and creates filter bubbles that homogenize taste and marginalize unconventional artistic expression.",
        "The postmodern dissolution of boundaries between high and popular culture has rendered traditional aesthetic hierarchies increasingly untenable in an era of radical cultural pluralism.",
        "Transmedia storytelling exploits the unique affordances of multiple platforms to construct narrative universes that exceed the expressive capacity of any single medium operating in isolation.",
        "The parasocial relationship phenomenon — wherein audiences develop one-sided emotional bonds with media personalities — has intensified exponentially through social media's manufactured intimacy.",
        "Intellectual property disputes in the entertainment industry reflect fundamental tensions between creators' moral rights, corporate ownership imperatives, and the public domain's role in cultural continuity.",
        "The attention economy framework positions entertainment products as competitors for finite cognitive resources, driving optimization toward engagement maximization over artistic or educational value.",
        "Representation in media operates as both mirror and window — reflecting existing social realities while simultaneously shaping audience perceptions of identity, possibility, and belonging.",
        "The neuroscience of narrative engagement reveals that compelling storytelling activates neural coupling between speaker and listener, synchronizing brain activity in ways that facilitate empathy and memory formation.",
        "Cultural appropriation debates in entertainment highlight irreconcilable perspectives on creative exchange, ranging from celebrations of cosmopolitan hybridity to condemnations of extractive cultural exploitation.",
        "The economics of content creation in the attention economy have produced a precariat class of creators whose labor generates enormous platform value while receiving minimal and unstable compensation.",
        "Nostalgia as a commercial strategy exploits the psychological comfort of familiarity, generating enormous revenue through reboots, remakes, and franchise extensions that prioritize recognition over originality.",
        "The phenomenology of aesthetic experience — understanding how artworks generate emotional, cognitive, and somatic responses — remains inadequately explained by either neuroscientific or philosophical frameworks alone.",
        "Interactive narrative in video games presents unique storytelling challenges including ludonarrative dissonance, player agency preservation, and the construction of meaningful choice architectures within designed possibility spaces.",
        "The globalization of entertainment has produced complex cultural flows wherein content is simultaneously localized for specific markets and standardized for global distribution, creating hybrid cultural forms.",
        "Artificial intelligence-generated creative works challenge fundamental assumptions about authorship, intentionality, and the role of human consciousness in aesthetic production and appreciation.",
      ],
    },
  };
